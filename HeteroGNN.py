...
"""## The Model: Heterogeneous GraphSAGE Model"""
...
def initialization():
    ...
    model = HeteroGNN_L(data.metadata(), hidden_channels=args.hidden_channels, out_channels=data.y_dict['all'].shape[-1],
                  num_layers=args.num_layers, in_channels = data.x_dict['all'].shape[-1]).to(device)
